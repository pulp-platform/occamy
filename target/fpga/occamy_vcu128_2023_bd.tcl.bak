...
proc create_root_design { parentCell } {
  ...
  set_property CONFIG.C_MON_TYPE {NATIVE} $ila_25
  ...
  connect_bd_net -net const_low_dout [get_bd_pins c_low/dout] [get_bd_pins axi_quad_spi_0/gsr] [get_bd_pins axi_quad_spi_0/gts] [get_bd_pins axi_quad_spi_0/usrcclkts] [get_bd_pins occamy/test_mode_i]
